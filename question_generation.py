...
# python3 question_generation.py --reference_corpus "data_store/averitec/dev.json" --top_k_target_knowledge "data_store/dev_reranking_olmo_top_k.json" --output_questions "data_store/dev_olmo_top_k_qa.json" --model "allenai/OLMo-2-1124-13B"