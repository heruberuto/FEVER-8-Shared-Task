...
#prepare dataset
dataset = load_dataset("json", data_files = {"train": os.path.join(DATASET_PATH, "train_nli_4concat_all_orders.jsonl"), "dev": os.path.join(DATASET_PATH, "dev_nli_4concat_all_orders.jsonl")})
...
training_args = TrainingArguments(
   output_dir=f"/home/mlynatom/models/averitec/nli_4_order/{model_id.split('/')[-1]}",
   learning_rate=1e-5,
